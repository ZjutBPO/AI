...
# 最终生成的数据形状，(148, 5, 3) (148,) (31, 5, 3) (31,)
...
# 拟合网络
history = model.fit(train_X, train_y, epochs=200, batch_size=train_X.shape[0], validation_data=(test_X, test_y), verbose=1, shuffle=False)
