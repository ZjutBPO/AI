...
# load dataset
dataset = read_csv('by5minutes/sta3.csv')
# 删掉那些我们不想预测的列
...
scaled.columns=['Num','Minute','DateType']
...
# 拟合网络
history = model.fit(train_X, train_y, epochs=100, batch_size=20, validation_split = 0.2, verbose=2, shuffle=True)
